# HARMONICHROMIA - Harbisson Dreamscape (LIVE)
...
puts "HARBISSON DREAMSCAPE (LIVE): Synaesthetic translation beginning..."
puts "Listening for live harmonica data..."
...
live_loop :dreamscape_melody do
  ...
  if data && data.length > 0
    ...
    puts "\nData as melody: #{data.map { |v| intensityToNote(v) }}"
    ...
    with_fx :reverb, room: 0.8, mix: 0.6 do
      with_fx :echo, phase: 0.75, mix: 0.4, decay: 4 do
        ...
        data.each_with_index do |intensity, position|
          ...
          # Peak detection - moment of beauty
          if intensity >= 4
